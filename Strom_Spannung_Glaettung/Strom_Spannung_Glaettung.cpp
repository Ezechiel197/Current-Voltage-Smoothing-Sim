...
// Strom_Spannung_Glaettung.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CStromSpannungGlaettungApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CStromSpannungGlaettungApp-Erstellung

CStromSpannungGlaettungApp::CStromSpannungGlaettungApp()
{
...
// Das einzige CStromSpannungGlaettungApp-Objekt

CStromSpannungGlaettungApp theApp;


// CStromSpannungGlaettungApp-Initialisierung

BOOL CStromSpannungGlaettungApp::InitInstance()
{
	...
	CStromSpannungGlaettungDlg dlg;
	m_pMainWnd = &dlg;
